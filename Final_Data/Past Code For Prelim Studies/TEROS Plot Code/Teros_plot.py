...
def load_and_process_data(args):
	...
	pkl_file = os.path.join(pkl_dir, "teros_0_2.pkl")		# file name for pickled data
...
def _plot_and_save_data(args, data_df):
	...
	start_time = datetime.date(2021,6,28)
	end_time = datetime.date(2021,7,20)
	...
	plt.ylabel("Moisture Content (v/v)")
	plt.ylim(0, 1)
